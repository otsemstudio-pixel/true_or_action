...
import { JOKER_IDS, fideleBonusDueForNextTurn, metronomeStreakBefore, hasUsedIncrevable, rituelStreakBefore } from './jokers.js';
...
function playNormalTurn(room, { text = 'réponse', bluff = false, votes, nextTurnRng = normalTurnRng() } = {}) {
